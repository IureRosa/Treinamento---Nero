...
% curva de Bèzier de 9º grau com 4 parâmetros
% "aproximados".
...
d1 = c1.*[sin(thf),cos(thf)];   d4 = c4.*[sin(ths),cos(ths)];

b1 = b0 + [(1/5).*d0]';         b4 = b9 - [(1/5).*d5]';

b2 = b1 + [(1/5).*d0]';         b3 = b4 - [(1/5).*d5]';      

b6 = b2 + [(1/5).*d1]';         b5 = b3 - [(1/5).*d4]';

b8 = b6 + [(1/5).*d1]';         b7 = b5 - [(1/5).*d4]';       %Inicialização aleatória


ControlPoints = [b0,b1,b2,b3,b4,b5,b6,b7,b8,b9]; %=> N = 10;
